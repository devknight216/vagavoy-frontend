        ...
        <div className="flex flex-col">
          ...
          <div className="flex flex-col mt-4 sm:mt-8 mb-[74px] sm:mb-[155px] text-left py-4 sm:py-[42px] px-4 sm:px-8 rounded-[16px] border-[1px]">
            ...
            <div className="flex flex-row  sm:mt-8 mt-4">
              <img
                src="/images/ar-flag.jpg"
                className="sm:w-[64px] sm:h-[44px] w-[44px] h-[31px]"
              />
              <div className="flex flex-col ml-3">
                ...
                <div className="mt-3 sm:text-base text-sm">
                  ...
                  Missouri. Although I wanted to, I hadn't been scuba diving
                  again since. But finally, six years later I got to go again -
                  but this time in Utila, in one of the biggest reefs in the
                  world!
                </div>
